...
<main class="app">
    ...
    <section class="create-todo">
        <h3>Créé une tache</h3>
        <form @submit.prevent="addTodo">
            <h4>Qu'avez vous sur votre TODO ?</h4>
            <input type="text" placeholder="Faire la vaiselle" v-model="input_content"/>
            ...
            <input type="submit" value="Ajouter à la TODO"/>
        </form>
